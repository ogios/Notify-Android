...
//
//public class NotificationSend_bak implements Runnable{
...
//
//
//    NotificationSend_bak(MainActivity mainActivity){
...
//            try{
//                if (NotificationSend_bak.isOporating){
//                    NotificationSend_bak.client.sendUrgentData(0xFF);
//                }
//            } catch (Exception e){
//                System.out.println("Connection break");
//                e.printStackTrace();
//                NotificationSend_bak.isOporating = false;
//                try {
//                    NotificationSend_bak.client.close();
//                    NotificationSend_bak.client = null;
//                    NotificationSend_bak.iconSended.clear();
